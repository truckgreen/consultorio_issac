...
object EquilibraDataRepository {

    val CLINIC_NAME = "EQUILIBRA"
    val CLINIC_TAGLINE = "Tu camino hacia el bienestar físico comienza aquí"
    val CLINIC_MOTTO = "El lugar donde la mente, el cuerpo y el movimiento encuentran su equilibrio."
    ...
    val CLINIC_HOURS = listOf(
        "Lunes a Viernes: 8:00am a 7:00pm",
        "Sábados: 8:00am a 2:00pm",
        "Domingos: Cerrado"
    )

    val PHILOSOPHY_PILLARS = listOf(
        "Ciencia & Evidencia" to "Protocolos validados internacionalmente con tecnología y medición objetiva.",
        "Atención 1 a 1" to "Sesiones personalizadas sin camillas masivas ni tiempos muertos.",
        "Educación & Empoderamiento" to "Comprenderás tu cuerpo para ser protagonista activo de tu propia recuperación."
    )
    ...
    val SERVICES: List<ServiceItem> = listOf(
        ServiceItem(
            ...
            targetAudience = listOf("Personas con dolores musculares o articulares", "Cervicalgias y lumbalgias", "Posturas laborales sedentarias"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Lactantes con retraso motor leve", "Niños y adolescentes con alteraciones posturales", "Pequeños atletas"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Adultos mayores que desean mantener su independencia", "Personas en recuperación post-operatoria de cadera/rodilla"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Futbolistas, corredores, crossfitters, tenistas", "Atletas de alto rendimiento y aficionados"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Personas con dolor articular persistente", "Pacientes con traumatismos recientes", "Segunda opinión médica"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Personas en procesos de rehabilitación prolongada", "Manejo del estrés y burnout", "Niños y adultos"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Deportistas en búsqueda de rendimiento", "Pacientes en recuperación de lesiones", "Poblaciones con condiciones clínicas"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Personas que buscan ponerse en forma con seguridad", "Pacientes con alta médica de fisioterapia"),
        ...
        ServiceItem(
            ...
            targetAudience = listOf("Cualquier persona que busque una actividad física divertida y desafiante", "Jóvenes y adultos"),
            methodology = "Trabajo de manoplas, saco, desplazamientos, sombra técnica y circuito de acondicionamiento físico."
        )
    )

    val TEAM_MEMBERS: List<TeamMember> = listOf(
        TeamMember(
            id = "isaac-jewsiejew",
    ...
    val SPECIALTIES: List<SpecialtyItem> = listOf(
        SpecialtyItem(
            ...
            subSpecialties = listOf("Traumatología", "Fisioterapia General", "Pediatría", "Geriatría", "Deportiva")
        ),
        SpecialtyItem(
            id = "salud-mental",
            ...
            subSpecialties = listOf("Psicología Clínica", "Psicología Deportiva", "Terapia Infantojuvenil", "Mindfulness")
        ),
        SpecialtyItem(
            ...
            subSpecialties = listOf("Nutrición Deportiva", "Nutrición Clínica & Metabólica", "Nutrición Pediátrica", "Recomposición Corporal")
        ),
        SpecialtyItem(
            ...
            subSpecialties = listOf("Entrenamiento Funcional", "Boxeo Terapéutico", "Movilidad & Core", "Reacondicionamiento Físico")
        )
    )

    val WHY_CHOOSE_US: List<WhyUsItem> = listOf(
        WhyUsItem(
    ...
    val STANDARD_WEEKDAY_SLOTS = listOf(
        "08:00 AM - 09:00 AM",
        "09:00 AM - 10:00 AM",
        "10:00 AM - 11:00 AM",
        "11:00 AM - 12:00 PM",
    ...
    fun getSlotsForDate(
        dateStr: String,
        userBookedAppointments: List<AppointmentEntity> = emptyList()
    ): List<TimeSlotInfo> {
        ...
        try {
            ...
            val baseSlots = if (dayOfWeek == 6) SATURDAY_SLOTS else STANDARD_WEEKDAY_SLOTS
