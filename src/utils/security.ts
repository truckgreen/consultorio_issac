...
export interface SecurityAuditEntry {
  id: string;
  timestamp: string;
  action: 'BOOKING_ATTEMPT' | 'BOOKING_SUCCESS' | 'CONTACT_SENT' | 'SUPPORT_TICKET_SENT' | 'AUTH_SUCCESS' | 'AUTH_FAILED' | 'RATE_LIMIT_BLOCKED' | 'BOT_TRAP_TRIGGERED' | 'APPOINTMENT_CANCEL_REQUEST' | 'SECURITY_EXPORT' | 'PATIENT_RECORD_CREATED' | 'PATIENT_RECORD_UPDATED';
